...
class AppConfig {
  ...
  static const String googleMapsApiKey = 'AIzaSyCE3jEztJrSAapjhUcv6PaQQSfIqJIZbq8';
  
  // Google Places API Key
  // Replace with your actual Google Places API key
  static const String googlePlacesApiKey = 'AIzaSyCE3jEztJrSAapjhUcv6PaQQSfIqJIZbq8';
